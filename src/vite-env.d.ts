interface ImportMetaEnv {
  ...
  readonly VITE_THEME_LIGHT_LINK_TEXT_COLOR: string;
  readonly VITE_THEME_LIGHT_ACCENT_TEXT_COLOR: string;
  ...
  readonly VITE_THEME_DARK_LINK_TEXT_COLOR: string;
  readonly VITE_THEME_DARK_ACCENT_TEXT_COLOR: string;
